...
class PEBPNet(nn.Module):
    """Photon enrichment with Bidirectional Propagation Network.
    ...
    def __init__(self, num_feat=64, num_block=8, num_in_ch = 1, upscale=1):
        super().__init__()
...
@ARCH_REGISTRY.register()
class PECBNet(nn.Module):
    """Photon enrichment with Temporal Coupled Propagation Network.
